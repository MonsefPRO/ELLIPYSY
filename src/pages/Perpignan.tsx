...
const schemaData = {
  ...
  "@type": "Service",
  "name": "Nettoyage par Drone et Robotique à Perpignan",
  "description": "Nettoyage professionnel par drone à Perpignan (Pyrénées-Orientales (66)) : panneaux photovoltaïques, façades, démoussage toiture, thermographie, destruction nids de frelons. Certifiés DGAC/EASA. À moins d'1h30 de Montpellier, intervention dans tout le 66.",
  "provider": {
    "@type": "LocalBusiness",
    ...
    "geo": { "@type": "GeoCoordinates", "latitude": "42.6887", "longitude": "2.8948" },
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Ellipsys Solutions intervient-il à Perpignan ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui. Ellipsys Solutions intervient à Perpignan et dans tout le Pyrénées-Orientales (66) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h30 de Montpellier, intervention dans tout le 66."
      }
    },
    {
      "@type": "Question",
      "name": "Quel est le délai d'intervention pour un nettoyage par drone à Perpignan ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Nous répondons à toute demande sous 24h. L'intervention est planifiée en fonction de vos contraintes. Devis gratuit et sans engagement pour tout projet à Perpignan."
      }
    },
    {
      "@type": "Question",
      "name": "Quels types de bâtiments nettoyez-vous à Perpignan ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "À Perpignan, nous intervenons sur les centrales solaires, serres agricoles, copropriétés, entrepôts. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle."
      }
    },
    {
      "@type": "Question",
      "name": "Combien coûte le nettoyage par drone à Perpignan ?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function VillePerpignan() {
  ...
  const faqs = [
    {
      q: isFr ? `Ellipsys Solutions intervient-il à Perpignan ?` : `Does Ellipsys Solutions operate in Perpignan?`,
      a: isFr ? `Oui. Nous intervenons à Perpignan et dans tout le Pyrénées-Orientales (66) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h30 de Montpellier, intervention dans tout le 66.` : `Yes. We operate in Perpignan and throughout Pyrénées-Orientales (66) for drone cleaning: solar panels, facades, roofs, thermography and hornet nest removal. À moins d'1h30 de Montpellier, intervention dans tout le 66.`
    },
    {
      q: isFr ? `Quel délai d'intervention à Perpignan ?` : `What is the response time in Perpignan?`,
    ...
    {
      q: isFr ? `Quels bâtiments nettoyez-vous à Perpignan ?` : `What buildings do you clean in Perpignan?`,
      a: isFr ? `À Perpignan, nous intervenons sur les centrales solaires, serres agricoles, copropriétés, entrepôts. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle.` : `In Perpignan, we operate on centrales solaires, serres agricoles, copropriétés, entrepôts. Our drones access all surfaces without scaffolding or platforms.`
    },
    {
      q: isFr ? `Combien coûte le nettoyage par drone à Perpignan ?` : `How much does drone cleaning cost in Perpignan?`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-blue-200" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span className="text-white font-bold" itemProp="name">{isFr ? 'Nettoyage Drone Perpignan' : 'Drone Cleaning Perpignan'}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-orange-300 font-bold uppercase tracking-widest text-sm">Pyrénées-Orientales (66) · Occitanie</span>
            </div>
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight">
              {isFr ? <>Nettoyage par<br />Drone & Robotique<br /><span className="text-orange-400">à Perpignan</span></> : <>Drone & Robotic<br />Cleaning<br /><span className="text-orange-400">in Perpignan</span></>}
            </h1>
            <p className="text-xl text-blue-100 font-bold max-w-2xl mb-8">
              {isFr
                ? `Panneaux solaires, façades, toitures, thermographie, nids de frelons — Certifiés DGAC/EASA. À moins d'1h30 de Montpellier, intervention dans tout le 66.`
                : `Solar panels, facades, roofs, thermography, hornet nests — DGAC/EASA Certified. À moins d'1h30 de Montpellier, intervention dans tout le 66.`}
            </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-6xl space-y-16">
        ...
        <ScrollReveal>
          <section className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-lg border border-gray-100">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-6 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Ellipsys Solutions intervient à Perpignan` : `Ellipsys Solutions operates in Perpignan`}
            </h2>
            <div className="prose prose-lg text-gray-600 max-w-none space-y-4 font-medium leading-relaxed">
              {isFr ? (
                <>
                  <p>Ellipsys Solutions est votre partenaire spécialisé en <strong>nettoyage par drone et robotique à Perpignan</strong>, capitale des Pyrénées-Orientales, forte exposition solaire. Nos équipes certifiées <strong>DGAC/EASA</strong> interviennent sur tous types de surfaces et d'infrastructures dans le Pyrénées-Orientales (66).</p>
                  ...
                  <p>Nous intervenons sur les <strong>centrales solaires, serres agricoles, copropriétés, entrepôts</strong> de Perpignan et de l'ensemble du Pyrénées-Orientales (66). À moins d'1h30 de Montpellier, intervention dans tout le 66.</p>
                </>
              ) : (
                <>
                  <p>Ellipsys Solutions is your specialist partner for <strong>drone and robotic cleaning in Perpignan</strong>, capitale des Pyrénées-Orientales, forte exposition solaire. Our <strong>DGAC/EASA</strong> certified teams operate on all surface types and infrastructures in Pyrénées-Orientales (66).</p>
                  ...
                  <p>We serve <strong>centrales solaires, serres agricoles, copropriétés, entrepôts</strong> in Perpignan and throughout Pyrénées-Orientales (66). À moins d'1h30 de Montpellier, intervention dans tout le 66.</p>
                </>
              )}
            </div>
        ...
        <ScrollReveal>
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Nos prestations à Perpignan` : `Our services in Perpignan`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-[#233B72] rounded-[2.5rem] p-8 md:p-12 text-white">
            <h2 className="text-2xl md:text-3xl font-black mb-8 uppercase tracking-tighter text-orange-400">
              {isFr ? `Pourquoi choisir Ellipsys à Perpignan ?` : `Why choose Ellipsys in Perpignan?`}
            </h2>
        ...
        <ScrollReveal>
          <section itemScope itemType="https://schema.org/FAQPage">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              <div className="w-2 h-10 bg-orange-500 rounded-full"></div>
              {isFr ? `Questions fréquentes — Perpignan` : `FAQ — Perpignan`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-orange-50 rounded-[2.5rem] p-10 md:p-14 border border-orange-100 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-4 uppercase tracking-tighter">
              {isFr ? `Un projet de nettoyage à Perpignan ?` : `A cleaning project in Perpignan?`}
            </h2>
            <p className="text-gray-600 font-medium mb-8 max-w-xl mx-auto">
              {isFr ? `Devis gratuit et personnalisé sous 24h. À moins d'1h30 de Montpellier, intervention dans tout le 66.` : `Free personalized quote within 24h. À moins d'1h30 de Montpellier, intervention dans tout le 66.`}
            </p>
