...
const schemaData = {
  ...
  "@type": "Service",
  "name": "Nettoyage par Drone et Robotique à Nîmes",
  "description": "Nettoyage professionnel par drone à Nîmes (Gard (30)) : panneaux photovoltaïques, façades, démoussage toiture, thermographie, destruction nids de frelons. Certifiés DGAC/EASA. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.",
  "provider": {
    "@type": "LocalBusiness",
    ...
    "geo": { "@type": "GeoCoordinates", "latitude": "43.8367", "longitude": "4.3601" },
    "areaServed": { "@type": "City", "name": "Nîmes" }
  },
  "areaServed": { "@type": "City", "name": "Nîmes" },
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Ellipsys Solutions intervient-il à Nîmes ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui. Ellipsys Solutions intervient à Nîmes et dans tout le Gard (30) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h de Montpellier, intervention rapide dans tout le Gard."
      }
    },
    {
      "@type": "Question",
      "name": "Quel est le délai d'intervention pour un nettoyage par drone à Nîmes ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Nous répondons à toute demande sous 24h. L'intervention est planifiée en fonction de vos contraintes. Devis gratuit et sans engagement pour tout projet à Nîmes."
      }
    },
    {
      "@type": "Question",
      "name": "Quels types de bâtiments nettoyez-vous à Nîmes ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "À Nîmes, nous intervenons sur les entrepôts, copropriétés, fermes solaires, toitures tuiles canal. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle."
      }
    },
    {
      "@type": "Question",
      "name": "Combien coûte le nettoyage par drone à Nîmes ?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function VilleNîmes() {
  ...
  const faqs = [
    {
      q: isFr ? `Ellipsys Solutions intervient-il à Nîmes ?` : `Does Ellipsys Solutions operate in Nîmes?`,
      a: isFr ? `Oui. Nous intervenons à Nîmes et dans tout le Gard (30) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.` : `Yes. We operate in Nîmes and throughout Gard (30) for drone cleaning: solar panels, facades, roofs, thermography and hornet nest removal. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.`
    },
    {
      q: isFr ? `Quel délai d'intervention à Nîmes ?` : `What is the response time in Nîmes?`,
    ...
    {
      q: isFr ? `Quels bâtiments nettoyez-vous à Nîmes ?` : `What buildings do you clean in Nîmes?`,
      a: isFr ? `À Nîmes, nous intervenons sur les entrepôts, copropriétés, fermes solaires, toitures tuiles canal. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle.` : `In Nîmes, we operate on entrepôts, copropriétés, fermes solaires, toitures tuiles canal. Our drones access all surfaces without scaffolding or platforms.`
    },
    {
      q: isFr ? `Combien coûte le nettoyage par drone à Nîmes ?` : `How much does drone cleaning cost in Nîmes?`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-blue-200" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span className="text-white font-bold" itemProp="name">{isFr ? 'Nettoyage Drone Nîmes' : 'Drone Cleaning Nîmes'}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-orange-300 font-bold uppercase tracking-widest text-sm">Gard (30) · Occitanie</span>
            </div>
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight">
              {isFr ? <>Nettoyage par<br />Drone & Robotique<br /><span className="text-orange-400">à Nîmes</span></> : <>Drone & Robotic<br />Cleaning<br /><span className="text-orange-400">in Nîmes</span></>}
            </h1>
            <p className="text-xl text-blue-100 font-bold max-w-2xl mb-8">
              {isFr
                ? `Panneaux solaires, façades, toitures, thermographie, nids de frelons — Certifiés DGAC/EASA. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.`
                : `Solar panels, facades, roofs, thermography, hornet nests — DGAC/EASA Certified. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.`}
            </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-6xl space-y-16">
        ...
        <ScrollReveal>
          <section className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-lg border border-gray-100">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-6 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Ellipsys Solutions intervient à Nîmes` : `Ellipsys Solutions operates in Nîmes`}
            </h2>
            <div className="prose prose-lg text-gray-600 max-w-none space-y-4 font-medium leading-relaxed">
              {isFr ? (
                <>
                  <p>Ellipsys Solutions est votre partenaire spécialisé en <strong>nettoyage par drone et robotique à Nîmes</strong>, ville du Gard aux nombreuses toitures historiques et sites industriels. Nos équipes certifiées <strong>DGAC/EASA</strong> interviennent sur tous types de surfaces et d'infrastructures dans le Gard (30).</p>
                  ...
                  <p>Nous intervenons sur les <strong>entrepôts, copropriétés, fermes solaires, toitures tuiles canal</strong> de Nîmes et de l'ensemble du Gard (30). À moins d'1h de Montpellier, intervention rapide dans tout le Gard.</p>
                </>
              ) : (
                <>
                  <p>Ellipsys Solutions is your specialist partner for <strong>drone and robotic cleaning in Nîmes</strong>, ville du Gard aux nombreuses toitures historiques et sites industriels. Our <strong>DGAC/EASA</strong> certified teams operate on all surface types and infrastructures in Gard (30).</p>
                  ...
                  <p>We serve <strong>entrepôts, copropriétés, fermes solaires, toitures tuiles canal</strong> in Nîmes and throughout Gard (30). À moins d'1h de Montpellier, intervention rapide dans tout le Gard.</p>
                </>
              )}
            </div>
        ...
        <ScrollReveal>
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Nos prestations à Nîmes` : `Our services in Nîmes`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-[#233B72] rounded-[2.5rem] p-8 md:p-12 text-white">
            <h2 className="text-2xl md:text-3xl font-black mb-8 uppercase tracking-tighter text-orange-400">
              {isFr ? `Pourquoi choisir Ellipsys à Nîmes ?` : `Why choose Ellipsys in Nîmes?`}
            </h2>
        ...
        <ScrollReveal>
          <section itemScope itemType="https://schema.org/FAQPage">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              <div className="w-2 h-10 bg-orange-500 rounded-full"></div>
              {isFr ? `Questions fréquentes — Nîmes` : `FAQ — Nîmes`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-orange-50 rounded-[2.5rem] p-10 md:p-14 border border-orange-100 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-4 uppercase tracking-tighter">
              {isFr ? `Un projet de nettoyage à Nîmes ?` : `A cleaning project in Nîmes?`}
            </h2>
            <p className="text-gray-600 font-medium mb-8 max-w-xl mx-auto">
              {isFr ? `Devis gratuit et personnalisé sous 24h. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.` : `Free personalized quote within 24h. À moins d'1h de Montpellier, intervention rapide dans tout le Gard.`}
            </p>
