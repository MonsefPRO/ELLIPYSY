...
export default function Nimes() {
  const { t, language } = useLanguage();
  const isFr = language === 'fr';

  // Données SEO locales pour Nîmes
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Ellipsys Solutions - Nettoyage Drone Nîmes",
    "description": "Spécialiste du nettoyage par drone à Nîmes et dans le Gard (30). Façades, toitures, panneaux solaires et destruction de nids de frelons.",
    "address": {
      "@type": "PostalAddress",
    ...
    "areaServed": "Nîmes, Alès, Uzès, Bagnols-sur-Cèze, Gard"
  };
  ...
  const services = [
    ...
    },
    {
      ...
      desc: isFr ? "Boostez votre rendement solaire sous le soleil du Gard. Eau osmosée pure." : "Boost your solar yield under the Gard sun. Pure osmosed water.",
    ...
    },
    {
      ...
      desc: isFr ? "Intervention d'urgence dans tout le bassin nîmois. Précision et sécurité." : "Emergency intervention throughout the Nîmes area. Precision and safety.",
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight drop-shadow-lg">
              {isFr ? "Nettoyage par Drone à" : "Drone Cleaning in"} <span className="text-brand-orange-400">Nîmes</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 font-bold italic drop-shadow-md mb-10 max-w-2xl mx-auto">
              {isFr 
                ? "L'expertise Ellipsys Solutions au service des entreprises, syndics et particuliers du bassin nîmois." 
                : "Ellipsys Solutions expertise serving businesses, property managers, and residents in the Nîmes area."}
            </p>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>
              <span className="text-[#1a2e5a] font-bold uppercase tracking-tight">Nîmes</span>
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-[#1a2e5a] mb-6 uppercase tracking-tighter">
                  {isFr ? "Votre expert local dans le Gard" : "Your local expert in the Gard area"}
                </h2>
                <div className="prose prose-lg text-gray-600 font-medium leading-relaxed">
                  <p>
                    {isFr 
                      ? "Ellipsys Solutions déploie sa flotte de drones certifiés DGAC sur tout le département du Gard (30) et la région Occitanie, pour des interventions rapides et sécurisées."
                      : "Ellipsys Solutions deploys its DGAC-certified drone fleet throughout the Gard department and the Occitanie region, for fast and secure operations."}
                  </p>
                  <p className="mt-4">
                    {isFr
                      ? "De Nîmes à Alès, en passant par Uzès et le littoral, notre technologie de nettoyage à l'eau osmosée basse pression garantit un résultat impeccable sans agresser vos toitures, façades ou panneaux solaires."
                      : "From Nîmes to Alès, including Uzès, our low-pressure pure osmosed water cleaning technology guarantees flawless results without damaging your roofs, facades, or solar panels."}
                  </p>
                </div>
              </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-black text-center text-[#1a2e5a] mb-12 uppercase tracking-tighter">
              {isFr ? "Nos interventions dans le 30" : "Our services in the 30 area"}
            </h2>
          ...
          <div className="bg-gradient-to-br from-[#1a2e5a] to-blue-900 rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter">
                {isFr ? "Un projet à Nîmes ou ses alentours ?" : "A project in or around Nîmes?"}
              </h2>
