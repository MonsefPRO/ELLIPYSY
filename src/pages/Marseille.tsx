...
export default function Marseille() {
  ...
  // Données SEO locales pour Marseille
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Ellipsys Solutions - Nettoyage Drone Marseille",
    "description": "Spécialiste du nettoyage par drone à Marseille et dans les Bouches-du-Rhône (13). Façades, toitures, panneaux solaires et destruction de nids de frelons.",
    "address": {
      "@type": "PostalAddress",
    ...
    "areaServed": "Marseille, Aix-en-Provence, Aubagne, La Ciotat, Bouches-du-Rhône"
  };
  ...
  const services = [
    {
      ...
      // LA FAMEUSE CORRECTION EST ICI : GUILLEMETS DOUBLES "..."
    ...
    },
    {
      ...
      desc: isFr ? "Boostez votre rendement solaire face au mistral et aux embruns. Eau osmosée." : "Boost your solar yield against the mistral and sea spray. Osmosed water.",
    ...
    },
    {
      ...
      desc: isFr ? "Intervention d'urgence dans la région marseillaise. Précision et sécurité." : "Emergency intervention in the Marseille region. Precision and safety.",
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight drop-shadow-lg">
              {isFr ? "Nettoyage par Drone à" : "Drone Cleaning in"} <span className="text-brand-orange-400">Marseille</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 font-bold italic drop-shadow-md mb-10 max-w-2xl mx-auto">
              {isFr 
                ? "L'expertise Ellipsys Solutions au service des entreprises, syndics et particuliers de la cité phocéenne." 
                : "Ellipsys Solutions expertise serving businesses, property managers, and residents of the Phocaean city."}
            </p>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>
              <span className="text-[#1a2e5a] font-bold uppercase tracking-tight">Marseille</span>
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-[#1a2e5a] mb-6 uppercase tracking-tighter">
                  {isFr ? "Votre expert local en région PACA" : "Your local expert in the PACA region"}
                </h2>
                <div className="prose prose-lg text-gray-600 font-medium leading-relaxed">
                  <p>
                    {isFr 
                      ? "Ellipsys Solutions déploie sa flotte de drones certifiés DGAC sur tout le département des Bouches-du-Rhône (13) et la région PACA, pour des interventions en milieu urbain ou industriel."
                      : "Ellipsys Solutions deploys its DGAC-certified drone fleet throughout the Bouches-du-Rhône department and the PACA region, for urban or industrial operations."}
                  </p>
                  <p className="mt-4">
                    {isFr
                      ? "De Marseille à Aix-en-Provence, la pollution urbaine, le mistral et les embruns marins salissent rapidement vos toitures et façades. Notre technologie de nettoyage à l'eau osmosée basse pression garantit un résultat impeccable, sans risque d'abrasion pour vos bâtiments."
                      : "From Marseille to Aix-en-Provence, urban pollution, the mistral wind, and sea spray quickly soil your roofs and facades. Our low-pressure pure osmosed water cleaning technology guarantees a flawless result, without any risk of abrasion for your buildings."}
                  </p>
                </div>
              </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-black text-center text-[#1a2e5a] mb-12 uppercase tracking-tighter">
              {isFr ? "Nos interventions dans le 13" : "Our services in the 13 area"}
            </h2>
          ...
          <div className="bg-gradient-to-br from-[#1a2e5a] to-blue-900 rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter">
                {isFr ? "Un projet à Marseille ou en région PACA ?" : "A project in Marseille or the PACA region?"}
              </h2>
