...
export default function Montpellier() {
  ...
  // Données SEO locales pour Montpellier
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Ellipsys Solutions - Nettoyage Drone Montpellier",
    "description": "Spécialiste du nettoyage par drone à Montpellier et dans l'Hérault (34). Façades, toitures, panneaux solaires et destruction de nids de frelons.",
    "address": {
      "@type": "PostalAddress",
    ...
    "areaServed": "Montpellier, Lattes, Pérols, Castelnau-le-Lez, Saint-Jean-de-Védas, Hérault"
  };
  ...
  const services = [
    ...
    },
    {
      ...
      desc: isFr ? "Boostez votre rendement solaire sous le soleil de l'Hérault. Eau osmosée pure." : "Boost your solar yield under the Hérault sun. Pure osmosed water.",
    ...
    },
    {
      ...
      desc: isFr ? "Intervention d'urgence dans tout le bassin montpelliérain. Précision et sécurité." : "Emergency intervention throughout the Montpellier area. Precision and safety.",
      ...
      <section className="relative h-[50vh] md:h-[70vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Nettoyage drone Montpellier"
          />
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight drop-shadow-lg">
              {isFr ? "Nettoyage par Drone à" : "Drone Cleaning in"} <span className="text-brand-orange-400">Montpellier</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 font-bold italic drop-shadow-md mb-10 max-w-2xl mx-auto">
              {isFr 
                ? "L'expertise Ellipsys Solutions au service des entreprises, syndics et particuliers du bassin montpelliérain." 
                : "Ellipsys Solutions expertise serving businesses, property managers, and residents in the Montpellier area."}
            </p>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>
              <span className="text-[#1a2e5a] font-bold uppercase tracking-tight">Montpellier</span>
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-[#1a2e5a] mb-6 uppercase tracking-tighter">
                  {isFr ? "Votre expert local en Occitanie" : "Your local expert in Occitanie"}
                </h2>
                <div className="prose prose-lg text-gray-600 font-medium leading-relaxed">
                  <p>
                    {isFr 
                      ? "Située au cœur de Montpellier (Parc d'Activités de l'Aéroport), Ellipsys Solutions déploie sa flotte de drones certifiés DGAC sur tout le département de l'Hérault et la région Occitanie."
                      : "Located in the heart of Montpellier, Ellipsys Solutions deploys its DGAC-certified drone fleet throughout the Hérault department and the Occitanie region."}
                  </p>
                  <p className="mt-4">
                    {isFr
                      ? "Le climat méditerranéen (embruns marins, pollens, fortes chaleurs, épisodes cévenols) met vos infrastructures à rude épreuve. Notre technologie de nettoyage à l'eau osmosée basse pression garantit un résultat impeccable sans agresser vos supports, que vous soyez à Port Marianne, Antigone, Castelnau-le-Lez ou dans l'arrière-pays."
                      : "The Mediterranean climate puts your infrastructure to the test. Our low-pressure pure osmosed water cleaning technology guarantees flawless results without damaging your surfaces."}
                  </p>
                </div>
              </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-black text-center text-[#1a2e5a] mb-12 uppercase tracking-tighter">
              {isFr ? "Nos interventions dans le 34" : "Our services in the 34 area"}
            </h2>
          ...
          <div className="bg-gradient-to-br from-[#1a2e5a] to-blue-900 rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter">
                {isFr ? "Un projet à Montpellier ou ses alentours ?" : "A project in or around Montpellier?"}
              </h2>
