...
const schemaData = {
  ...
  "@type": "Service",
  "name": "Nettoyage par Drone et Robotique à Montpellier",
  "description": "Nettoyage professionnel par drone à Montpellier (Hérault (34)) : panneaux photovoltaïques, façades, démoussage toiture, thermographie, destruction nids de frelons. Certifiés DGAC/EASA. Basés à Montpellier, intervention immédiate sans frais de déplacement.",
  "provider": {
    "@type": "LocalBusiness",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Ellipsys Solutions intervient-il à Montpellier ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui. Ellipsys Solutions intervient à Montpellier et dans tout le Hérault (34) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. Basés à Montpellier, intervention immédiate sans frais de déplacement."
      }
    },
    {
      "@type": "Question",
      "name": "Quel est le délai d'intervention pour un nettoyage par drone à Montpellier ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Nous répondons à toute demande sous 24h. L'intervention est planifiée en fonction de vos contraintes. Devis gratuit et sans engagement pour tout projet à Montpellier."
      }
    },
    {
      "@type": "Question",
      "name": "Quels types de bâtiments nettoyez-vous à Montpellier ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "À Montpellier, nous intervenons sur les entrepôts logistiques, copropriétés, centrales solaires agrivoltaïques. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle."
      }
    },
    {
      "@type": "Question",
      "name": "Combien coûte le nettoyage par drone à Montpellier ?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function VilleMontpellier() {
  ...
  const faqs = [
    {
      q: isFr ? `Ellipsys Solutions intervient-il à Montpellier ?` : `Does Ellipsys Solutions operate in Montpellier?`,
      a: isFr ? `Oui. Nous intervenons à Montpellier et dans tout le Hérault (34) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. Basés à Montpellier, intervention immédiate sans frais de déplacement.` : `Yes. We operate in Montpellier and throughout Hérault (34) for drone cleaning: solar panels, facades, roofs, thermography and hornet nest removal. Basés à Montpellier, intervention immédiate sans frais de déplacement.`
    },
    {
      q: isFr ? `Quel délai d'intervention à Montpellier ?` : `What is the response time in Montpellier?`,
    ...
    {
      q: isFr ? `Quels bâtiments nettoyez-vous à Montpellier ?` : `What buildings do you clean in Montpellier?`,
      a: isFr ? `À Montpellier, nous intervenons sur les entrepôts logistiques, copropriétés, centrales solaires agrivoltaïques. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle.` : `In Montpellier, we operate on entrepôts logistiques, copropriétés, centrales solaires agrivoltaïques. Our drones access all surfaces without scaffolding or platforms.`
    },
    {
      q: isFr ? `Combien coûte le nettoyage par drone à Montpellier ?` : `How much does drone cleaning cost in Montpellier?`,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-blue-200" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span className="text-white font-bold" itemProp="name">{isFr ? 'Nettoyage Drone Montpellier' : 'Drone Cleaning Montpellier'}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-orange-300 font-bold uppercase tracking-widest text-sm">Hérault (34) · Occitanie</span>
            </div>
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight">
              {isFr ? <>Nettoyage par<br />Drone & Robotique<br /><span className="text-orange-400">à Montpellier</span></> : <>Drone & Robotic<br />Cleaning<br /><span className="text-orange-400">in Montpellier</span></>}
            </h1>
            <p className="text-xl text-blue-100 font-bold max-w-2xl mb-8">
              {isFr
                ? `Panneaux solaires, façades, toitures, thermographie, nids de frelons — Certifiés DGAC/EASA. Basés à Montpellier, intervention immédiate sans frais de déplacement.`
                : `Solar panels, facades, roofs, thermography, hornet nests — DGAC/EASA Certified. Basés à Montpellier, intervention immédiate sans frais de déplacement.`}
            </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-6xl space-y-16">
        ...
        <ScrollReveal>
          <section className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-lg border border-gray-100">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-6 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Ellipsys Solutions intervient à Montpellier` : `Ellipsys Solutions operates in Montpellier`}
            </h2>
            <div className="prose prose-lg text-gray-600 max-w-none space-y-4 font-medium leading-relaxed">
              {isFr ? (
                <>
                  <p>Ellipsys Solutions est votre partenaire spécialisé en <strong>nettoyage par drone et robotique à Montpellier</strong>, capitale régionale de l'Occitanie. Nos équipes certifiées <strong>DGAC/EASA</strong> interviennent sur tous types de surfaces et d'infrastructures dans le Hérault (34).</p>
                  ...
                  <p>Nous intervenons sur les <strong>entrepôts logistiques, copropriétés, centrales solaires agrivoltaïques</strong> de Montpellier et de l'ensemble du Hérault (34). Basés à Montpellier, intervention immédiate sans frais de déplacement.</p>
                </>
              ) : (
                <>
                  <p>Ellipsys Solutions is your specialist partner for <strong>drone and robotic cleaning in Montpellier</strong>, capitale régionale de l'Occitanie. Our <strong>DGAC/EASA</strong> certified teams operate on all surface types and infrastructures in Hérault (34).</p>
                  ...
                  <p>We serve <strong>entrepôts logistiques, copropriétés, centrales solaires agrivoltaïques</strong> in Montpellier and throughout Hérault (34). Basés à Montpellier, intervention immédiate sans frais de déplacement.</p>
                </>
              )}
            </div>
        ...
        {/* Nos 5 prestations à Montpellier */}
        <ScrollReveal>
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Nos prestations à Montpellier` : `Our services in Montpellier`}
            </h2>
        ...
        {/* Pourquoi Ellipsys à Montpellier */}
        <ScrollReveal>
          <section className="bg-[#233B72] rounded-[2.5rem] p-8 md:p-12 text-white">
            <h2 className="text-2xl md:text-3xl font-black mb-8 uppercase tracking-tighter text-orange-400">
              {isFr ? `Pourquoi choisir Ellipsys à Montpellier ?` : `Why choose Ellipsys in Montpellier?`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-orange-50 rounded-[2.5rem] p-10 md:p-14 border border-orange-100 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-4 uppercase tracking-tighter">
              {isFr ? `Un projet de nettoyage à Montpellier ?` : `A cleaning project in Montpellier?`}
            </h2>
            <p className="text-gray-600 font-medium mb-8 max-w-xl mx-auto">
              {isFr ? `Devis gratuit et personnalisé sous 24h. Basés à Montpellier, intervention immédiate sans frais de déplacement.` : `Free personalized quote within 24h. Basés à Montpellier, intervention immédiate sans frais de déplacement.`}
            </p>
