...
export default function Carcassonne() {
  const { t, language } = useLanguage();
  const isFr = language === 'fr';

  // Données SEO locales pour Carcassonne
  const localSchema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    "name": "Ellipsys Solutions - Nettoyage Drone Carcassonne",
    "description": "Spécialiste du nettoyage par drone à Carcassonne et dans l'Aude (11). Façades, toitures, panneaux solaires et destruction de nids de frelons.",
    "address": {
      "@type": "PostalAddress",
    ...
    "areaServed": "Carcassonne, Narbonne, Limoux, Lézignan-Corbières, Aude"
  };
  ...
  const services = [
    ...
    },
    {
      ...
      desc: isFr ? "Boostez votre rendement solaire sous le soleil de l'Aude. Eau osmosée pure." : "Boost your solar yield under the Aude sun. Pure osmosed water.",
    ...
    },
    {
      ...
      desc: isFr ? "Intervention d'urgence dans tout le bassin audois. Précision et sécurité." : "Emergency intervention throughout the Aude area. Precision and safety.",
      ...
      <section className="relative h-[50vh] md:h-[70vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Nettoyage drone Carcassonne"
          />
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight drop-shadow-lg">
              {isFr ? "Nettoyage par Drone à" : "Drone Cleaning in"} <span className="text-brand-orange-400">Carcassonne</span>
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 font-bold italic drop-shadow-md mb-10 max-w-2xl mx-auto">
              {isFr 
                ? "L'expertise Ellipsys Solutions au service des entreprises, syndics et particuliers du bassin audois." 
                : "Ellipsys Solutions expertise serving businesses, property managers, and residents in the Aude area."}
            </p>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>
              <span className="text-[#1a2e5a] font-bold uppercase tracking-tight">Carcassonne</span>
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-black text-[#1a2e5a] mb-6 uppercase tracking-tighter">
                  {isFr ? "Votre expert local dans l'Aude" : "Your local expert in the Aude area"}
                </h2>
                <div className="prose prose-lg text-gray-600 font-medium leading-relaxed">
                  <p>
                    {isFr 
                      ? "Ellipsys Solutions déploie sa flotte de drones certifiés DGAC sur tout le département de l'Aude (11) et la région Occitanie, pour des interventions rapides et sécurisées."
                      : "Ellipsys Solutions deploys its DGAC-certified drone fleet throughout the Aude department and the Occitanie region, for fast and secure operations."}
                  </p>
                  <p className="mt-4">
                    {isFr
                      ? "De Carcassonne à Narbonne, le vent (Cers et Tramontane) et les intempéries encrassent vos toitures et façades. Notre technologie de nettoyage à l'eau osmosée basse pression garantit un résultat impeccable, tout en douceur."
                      : "From Carcassonne to Narbonne, wind and weather soil your roofs and facades. Our low-pressure pure osmosed water cleaning technology guarantees a flawless, gentle result."}
                  </p>
                </div>
              </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-black text-center text-[#1a2e5a] mb-12 uppercase tracking-tighter">
              {isFr ? "Nos interventions dans le 11" : "Our services in the 11 area"}
            </h2>
          ...
          <div className="bg-gradient-to-br from-[#1a2e5a] to-blue-900 rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter">
                {isFr ? "Un projet à Carcassonne ou ses alentours ?" : "A project in or around Carcassonne?"}
              </h2>
