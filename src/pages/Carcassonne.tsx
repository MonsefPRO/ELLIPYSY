...
const schemaData = {
  ...
  "@type": "Service",
  "name": "Nettoyage par Drone et Robotique à Carcassonne",
  "description": "Nettoyage professionnel par drone à Carcassonne (Aude (11)) : panneaux photovoltaïques, façades, démoussage toiture, thermographie, destruction nids de frelons. Certifiés DGAC/EASA. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.",
  "provider": {
    "@type": "LocalBusiness",
    ...
    "geo": { "@type": "GeoCoordinates", "latitude": "43.2130", "longitude": "2.3491" },
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Ellipsys Solutions intervient-il à Carcassonne ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Oui. Ellipsys Solutions intervient à Carcassonne et dans tout le Aude (11) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude."
      }
    },
    {
      "@type": "Question",
      "name": "Quel est le délai d'intervention pour un nettoyage par drone à Carcassonne ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Nous répondons à toute demande sous 24h. L'intervention est planifiée en fonction de vos contraintes. Devis gratuit et sans engagement pour tout projet à Carcassonne."
      }
    },
    {
      "@type": "Question",
      "name": "Quels types de bâtiments nettoyez-vous à Carcassonne ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "À Carcassonne, nous intervenons sur les domaines viticoles, copropriétés, toitures tuiles, fermes solaires Aude. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle."
      }
    },
    {
      "@type": "Question",
      "name": "Combien coûte le nettoyage par drone à Carcassonne ?",
      "acceptedAnswer": {
        "@type": "Answer",
...
export default function VilleCarcassonne() {
  ...
  const faqs = [
    {
      q: isFr ? `Ellipsys Solutions intervient-il à Carcassonne ?` : `Does Ellipsys Solutions operate in Carcassonne?`,
      a: isFr ? `Oui. Nous intervenons à Carcassonne et dans tout le Aude (11) pour le nettoyage par drone : panneaux solaires, façades, toitures, thermographie et destruction de nids de frelons. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.` : `Yes. We operate in Carcassonne and throughout Aude (11) for drone cleaning: solar panels, facades, roofs, thermography and hornet nest removal. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.`
    },
    {
      q: isFr ? `Quel délai d'intervention à Carcassonne ?` : `What is the response time in Carcassonne?`,
    ...
    {
      q: isFr ? `Quels bâtiments nettoyez-vous à Carcassonne ?` : `What buildings do you clean in Carcassonne?`,
      a: isFr ? `À Carcassonne, nous intervenons sur les domaines viticoles, copropriétés, toitures tuiles, fermes solaires Aude. Nos drones accèdent à toutes les surfaces sans échafaudage ni nacelle.` : `In Carcassonne, we operate on domaines viticoles, copropriétés, toitures tuiles, fermes solaires Aude. Our drones access all surfaces without scaffolding or platforms.`
    },
    {
      q: isFr ? `Combien coûte le nettoyage par drone à Carcassonne ?` : `How much does drone cleaning cost in Carcassonne?`,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-blue-200" itemScope itemType="https://schema.org/BreadcrumbList">
              ...
              <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
                <span className="text-white font-bold" itemProp="name">{isFr ? 'Nettoyage Drone Carcassonne' : 'Drone Cleaning Carcassonne'}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-orange-300 font-bold uppercase tracking-widest text-sm">Aude (11) · Occitanie</span>
            </div>
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 uppercase tracking-tighter leading-tight">
              {isFr ? <>Nettoyage par<br />Drone & Robotique<br /><span className="text-orange-400">à Carcassonne</span></> : <>Drone & Robotic<br />Cleaning<br /><span className="text-orange-400">in Carcassonne</span></>}
            </h1>
            <p className="text-xl text-blue-100 font-bold max-w-2xl mb-8">
              {isFr
                ? `Panneaux solaires, façades, toitures, thermographie, nids de frelons — Certifiés DGAC/EASA. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.`
                : `Solar panels, facades, roofs, thermography, hornet nests — DGAC/EASA Certified. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.`}
            </p>
      ...
      <main className="container mx-auto px-4 py-16 max-w-6xl space-y-16">
        ...
        <ScrollReveal>
          <section className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-lg border border-gray-100">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-6 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Ellipsys Solutions intervient à Carcassonne` : `Ellipsys Solutions operates in Carcassonne`}
            </h2>
            <div className="prose prose-lg text-gray-600 max-w-none space-y-4 font-medium leading-relaxed">
              {isFr ? (
                <>
                  <p>Ellipsys Solutions est votre partenaire spécialisé en <strong>nettoyage par drone et robotique à Carcassonne</strong>, ville de l'Aude aux nombreuses toitures historiques et domaines viticoles. Nos équipes certifiées <strong>DGAC/EASA</strong> interviennent sur tous types de surfaces et d'infrastructures dans le Aude (11).</p>
                  ...
                  <p>Nous intervenons sur les <strong>domaines viticoles, copropriétés, toitures tuiles, fermes solaires Aude</strong> de Carcassonne et de l'ensemble du Aude (11). À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.</p>
                </>
              ) : (
                <>
                  <p>Ellipsys Solutions is your specialist partner for <strong>drone and robotic cleaning in Carcassonne</strong>, ville de l'Aude aux nombreuses toitures historiques et domaines viticoles. Our <strong>DGAC/EASA</strong> certified teams operate on all surface types and infrastructures in Aude (11).</p>
                  ...
                  <p>We serve <strong>domaines viticoles, copropriétés, toitures tuiles, fermes solaires Aude</strong> in Carcassonne and throughout Aude (11). À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.</p>
                </>
              )}
            </div>
        ...
        {/* Nos 5 prestations à Carcassonne */}
        <ScrollReveal>
          <section>
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              ...
              {isFr ? `Nos prestations à Carcassonne` : `Our services in Carcassonne`}
            </h2>
        ...
        {/* Pourquoi Ellipsys à Carcassonne */}
        <ScrollReveal>
          <section className="bg-[#233B72] rounded-[2.5rem] p-8 md:p-12 text-white">
            <h2 className="text-2xl md:text-3xl font-black mb-8 uppercase tracking-tighter text-orange-400">
              {isFr ? `Pourquoi choisir Ellipsys à Carcassonne ?` : `Why choose Ellipsys in Carcassonne?`}
            </h2>
        ...
        <ScrollReveal>
          <section itemScope itemType="https://schema.org/FAQPage">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-8 uppercase tracking-tighter flex items-center gap-3">
              <div className="w-2 h-10 bg-orange-500 rounded-full"></div>
              {isFr ? `Questions fréquentes — Carcassonne` : `FAQ — Carcassonne`}
            </h2>
        ...
        <ScrollReveal>
          <section className="bg-orange-50 rounded-[2.5rem] p-10 md:p-14 border border-orange-100 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-[#233B72] mb-4 uppercase tracking-tighter">
              {isFr ? `Un projet de nettoyage à Carcassonne ?` : `A cleaning project in Carcassonne?`}
            </h2>
            <p className="text-gray-600 font-medium mb-8 max-w-xl mx-auto">
              {isFr ? `Devis gratuit et personnalisé sous 24h. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.` : `Free personalized quote within 24h. À moins d'1h de Montpellier, intervention rapide dans tout l'Aude.`}
            </p>
