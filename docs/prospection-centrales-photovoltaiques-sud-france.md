# Prospection Ellipsys — Centrales photovoltaïques du Sud de la France jamais nettoyées

> Rapport de prospection commerciale — nettoyage par drone
> Périmètre : PACA, Occitanie, sud Nouvelle-Aquitaine, Corse
> Date : juillet 2026

---

## 1. La logique de ciblage (important à comprendre)

Il n'existe **aucun registre public** indiquant qu'une centrale « n'a jamais été nettoyée ».
On identifie donc les cibles par **faisceau d'indices** :

| Indice | Pourquoi c'est un signal |
|---|---|
| **Mise en service 2008–2014** | 12 à 18 ans d'encrassement cumulé ; le nettoyage curatif était quasi inexistant dans les contrats O&M de l'époque |
| **Tarif d'achat historique élevé** (contrats S06/S10, 20 ans) | Jusqu'à 0,30–0,60 €/kWh → chaque % de salissure coûte très cher → **ROI du nettoyage imbattable** |
| **Zone poussiéreuse** : plateaux provençaux (mistral + poussière), plaine viticole/agricole (pollen, moissons, traitements), proximité carrières/axes routiers | Encrassement accéléré, 5 à 15 % de pertes typiques, jusqu'à 25 % dans les cas extrêmes |
| **Faible inclinaison des panneaux** (< 15°) | La pluie ne rince pas, dépôts calcaires et lichens s'incrustent |
| **Propriétaire PME / agriculteur** (hangars, serres PV, ombrières) | Pas de contrat O&M structuré → quasi certitude de « jamais nettoyé » |
| **Fin de contrat d'achat 2028–2031** | L'exploitant veut maximiser chaque kWh avant la fin du tarif bonifié → moment idéal pour vendre |
...
|---|---|---|---|---|---|
| **Narbonne – La Nautique** | 11 | ~7 | **2008** | EDF Renouvelables | La doyenne des centrales au sol françaises. 18 ans. Vent + poussière narbonnaise |
| **Losse / Gabardan** | 40 | 67,5 | 2010–2011 | EDF Renouvelables | Immense, en zone forestière/agricole (pollens de pin massifs) |
| **Curbans** | 04 | 33 | 2011 | ENGIE Green (ex-GDF Suez) | 1 000 m d'altitude, 145 000 panneaux, 60 ha |
| **Plateau des Mées / Puimichel** | 04 | ~100 cumulés | 2011–2012 | Multi-exploitants (Eco Delta, Enfinity, Siemens…) | Plusieurs centrales voisines = plusieurs contrats possibles en une visite. Plateau poussiéreux typique |
| **Ortaffa** | 66 | 25 | 2013 | EDF Renouvelables | Plaine du Roussillon : tramontane + poussière + pollens de vigne |
| **Torreilles** | 66 | ~9 | 2011 | (à vérifier) | Même contexte Roussillon |
| **Vinon-sur-Verdon** | 83 | ~4 | 2009 | (à vérifier) | Très ancienne, Provence |
| **Sainte-Tulle / vallée de la Durance** | 04 | ~5 | 2010–2011 | (à vérifier) | Couloir de la Durance, plusieurs sites |
| **Istres / étang de Berre** | 13 | divers | 2011–2012 | (à vérifier) | Pollution industrielle + embruns = encrassement sévère |
| **Signes / plateaux du Var** | 83 | divers | 2011–2012 | (à vérifier) | Plateaux calcaires poussiéreux |

**Astuce terrain** : le plateau des Mées et la vallée de la Durance concentrent des dizaines de MW en quelques kilomètres → une seule tournée de prospection couvre 5–10 exploitants.

---

## 4. Le gisement caché (souvent plus rentable) : le diffus agricole 2009–2011

Le boom des tarifs 2009–2011 a couvert le sud de **milliers de hangars agricoles, serres photovoltaïques et caves coopératives** (100–500 kWc chacun) :

- Propriétaires : agriculteurs, caves viticoles, coopératives — **aucun contrat O&M**, quasi jamais nettoyés en 15 ans ;
- Tarifs **intégré au bâti = les plus élevés** (0,50–0,60 €/kWh) → le ROI du nettoyage y est maximal ;
- Environnement : moissons, labours, traitements viticoles → encrassement extrême ;
- Zones denses : plaine viticole de l'Hérault et de l'Aude, Gard rhodanien, vallée de la Garonne (Tarn-et-Garonne, Lot-et-Garonne — vergers), plaine du Roussillon, Bouches-du-Rhône agricoles.
- Canaux d'entrée : chambres d'agriculture, caves coopératives, CUMA, salons (SITEVI Montpellier, Med'Agri Avignon), et les installateurs historiques de l'époque qui ont gardé le fichier clients.

---

## 5. Qui démarcher : exploitants et asset managers basés dans le sud

Les décisions de nettoyage se prennent chez l'exploitant/asset manager, pas sur site :

| Société | Siège | Profil |
|---|---|---|
| **Urbasolar (groupe Axpo)** | Montpellier | Gros portefeuille sud, dont sites anciens |
| **Valeco (EnBW)** | Montpellier | Nombreuses centrales Occitanie |
| **Tenergie** | Aix-en-Provence | Des centaines de toitures/hangars PACA — cible idéale |
| **CVE** | Marseille | Portefeuille diffus important |
| **Arkolia Énergies** | Mauguio (34) | Spécialiste hangars agricoles |
| **Reden Solar** | Roquefort (47) | Beaucoup de serres PV anciennes |
| **Amarenco** | Sud-Ouest | Toitures agricoles |
| **EDF Renouvelables / ENGIE Green / TotalEnergies / Neoen / Voltalia** | national | Passer par les responsables O&M régionaux (agences à Aix, Montpellier, Béziers, Bordeaux) |
| **O&M indépendants** (à approcher en partenariat plutôt qu'en concurrence) | — | Ils sous-traitent souvent le nettoyage : devenir **leur** sous-traitant drone démultiplie les volumes |

---

## 6. Comment vérifier « jamais nettoyé » (méthode)

1. **Registre national des installations de production** (open data ODRÉ / data.gouv.fr) : filtrer les installations PV > 100 kWc, mise en service < 2015, départements 04, 05, 06, 11, 12, 13, 30, 31, 32, 33, 34, 40, 47, 46, 48, 64, 65, 66, 81, 82, 83, 84, 2A, 2B → **fichier de prospection exhaustif gratuit** (commune + puissance + date).
2. **Imagerie satellite** (Google Earth historique) : traces de salissure homogène, végétation, absence de traces de passage d'engins de nettoyage.
3. **Question qualifiante en appel** : « Quel est votre performance ratio actuel vs l'année 1 ? » — une dérive > dégradation naturelle (−0,5 %/an) trahit l'encrassement.
4. **Offre d'audit gratuit par drone** (inspection thermique + visuelle) : porte d'entrée commerciale qui documente l'encrassement et chiffre la perte — le devis de nettoyage se vend ensuite tout seul.
...
- [Sénat — Révision des tarifs d'achat des contrats photovoltaïques 2006–2011](https://www.senat.fr/rap/r20-864/r20-864_mono.html)
- [Enerzine — Tarifs 2010 d'achat de l'électricité photovoltaïque](https://www.enerzine.com/les-tarifs-2010-dachat-de-lelectricite-photovoltaique/9723-2009-09)
- [Wikipédia — Centrale solaire photovoltaïque de Losse (Gabardan)](https://fr.wikipedia.org/wiki/Centrale_solaire_photovolta%C3%AFque_de_Losse)
- [Le Moniteur — La centrale solaire de Curbans lancée](https://www.lemoniteur.fr/article/la-centrale-solaire-de-curbans-lancee.849349)
- [Mairie d'Ortaffa — Centrale photovoltaïque](https://www.mairie-ortaffa.fr/le-developpement-durable/centrale-photovoltaique/)
- [Robsys — Que se passe-t-il si les centrales solaires ne sont pas nettoyées ?](https://rob-sys.com/fr/que-se-passe-t-il-si-les-centrales-solaires-ne-sont-pas-nettoyees/)
- [Solartop — Pertes de production invisibles des grandes installations](https://solartop.fr/pertes-de-production-invisibles-les-couts-caches-pour-les-grandes-installations-solaires/)
- [Fournisseurs-electricite.com — Les grandes centrales solaires de France](https://www.fournisseurs-electricite.com/contrat-electricite/centrales-solaires-france)
